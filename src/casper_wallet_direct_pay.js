...
import { CLPublicKey, CLU512, CasperServiceByJsonRPC, DeployUtil, PurseIdentifier } from "casper-js-sdk";
...
async function direct_pay(sender_publicKey, reciver_publicKey, amount_in_usd){
    ...
    let casper_service = new CasperServiceByJsonRPC("https://apiv2.droplinked.com/http-req?method=post&url=http://45.14.135.77:7777/rpc");
